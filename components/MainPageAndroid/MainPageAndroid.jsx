...
export default function MainPageAndroid() {
  ...
  const navigationView = () => (
    <View style={[styles.containerNav, styles.navigationContainer]}>
      <TitleText>Map will be added soon</TitleText>
    </View>
  );
          ...
          <View style={styles.InputBox}>
            ...
            <View style={styles.inputContainer}>
              ...
              <TextInput
                ...
                ref={InputRef}
                onChangeText={(text) => setInputText(value)}
              ></TextInput>
            </View>
            <Pressable
